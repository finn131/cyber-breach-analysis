...
def main() -> None:
    ...
    st.markdown(
        ...
        <div class="hero-shell">
            ...
            <div class="hero-cta">
                <span class="hero-cta-pill">Processed dataset only</span>
                <span class="hero-cta-pill secondary">Streamlit multipage app</span>
                <span class="hero-cta-pill secondary">Plotly-driven visuals</span>
            </div>
        </div>
        """,
